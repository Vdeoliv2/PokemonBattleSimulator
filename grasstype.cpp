...
grasstype::grasstype(const string &_poke_name, const string &_type, int _HP, int _ID,const vector<Attack*> & _attackSet):pokemon(_poke_name,_type,_HP,_ID,_attackSet)
{  
...
void grasstype::updateDamages(const string &_enemy_type,const string &_previous_enemy_type)
{
    ...
    if(_previous_enemy_type=="water type")
    {
    ...
    //I am supposing grass types have advantage with water types and disadvantages with fire types

    
    if(_enemy_type=="water type")
    {
