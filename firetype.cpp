#include "firetype.h"
firetype::firetype(const string &_poke_name, const string &_type, int _HP, int _ID,const vector<Attack*> & _attackSet):pokemon(_poke_name,_type,_HP,_ID,_attackSet)
{  
...
void firetype::updateDamages(const string &_enemy_type,const string &_previous_enemy_type)
{
...
if(_previous_enemy_type=="water type")
{
    ...
    //I am supposing fire types have advantage with grass types and disadvantages with water types
